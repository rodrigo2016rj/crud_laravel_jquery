...
<script src="{{asset('js/editar_pessoa/controles.js')}}"></script>
<script src="{{asset('js/editar_pessoa/interacoes.js')}}"></script>
...
<div id="div_pagina_editar_pessoa">
  ...
  <form id="form_editar" method="post" action="/editar_pessoa/editar">
    ...
    <div id="div_botao_editar">
      ...
      <input type="submit" id="botao_editar" value="Editar"/>
    </div>
  </form>
  <div id="div_calendario" class="tag_oculta">
    ...
    <div id="div_rodape_do_calendario">
      <div id="div_botoes_do_calendario">
        <button type="button" id="botao_confirmar_do_calendario">Confirmar</button>
      </div>
    </div>
  </div>
